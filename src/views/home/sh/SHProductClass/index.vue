  ...
  <div class="container">
    ...
    >
      <el-form ref="form" :model="form">
        <el-form-item label="售后产品类别名称">
          <el-input v-model="form.ProductClass" type="text"></el-input>
        </el-form-item>
      </el-form>
    ...
    async onSubmit() {
      ...
      if (this.operation === "add") {
        ...
        await this.$https({
          ...
          params: {
            table: "__SHProductClass",
            where: { ProductClass: this.form.ProductClass },
            dataBase: "base",
          },
        })
          .then((res) => {

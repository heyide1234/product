<template>
  <div class="container">
    <el-steps :active="0" finish-status="success" simple style="margin: 5px">
      <el-step title="售后处理方式维护表"></el-step>
    ...
    >
      <el-form ref="form" :model="form">
        <el-form-item label="售后处理方式代号">
          <el-input v-model="form.TreatmentMethodCode" type="text"></el-input>
        </el-form-item>
        <el-form-item label="售后处理方式名称">
          <el-input v-model="form.TreatmentMethod" type="text"></el-input>
        </el-form-item>
        <el-form-item label="售后处理方式描述">
          <el-input
            v-model="form.TreatmentMethodRemarks"
            type="text"
          ></el-input>
        </el-form-item>
      </el-form>
    ...
    <div class="tabels">
      ...
      >
        ...
        ></el-table-column>
        <el-table-column
          property="TreatmentMethodRemarks"
          label="售后处理方式描述"
        ></el-table-column>
...
export default {
  data() {
    return {
      ...
      pagenums: 0,
      form: {
        TreatmentMethodCode: "", //售后处理方式代号
        TreatmentMethod: "", //售后处理方式名称
        TreatmentMethodRemarks: "", //售后处理方式描述
        creater: "", //创建人
        creatdate: "", //创建时间
      },
      total: 0,
  ...
  methods: {
    ...
    handleAdd() {
      this.operation = "add";
      this.form.TreatmentMethodCode = ""; //售后处理方式代号
      this.form.TreatmentMethod = ""; //售后处理方式名称
      this.form.TreatmentMethodRemarks = ""; //售后处理方式描述
    ...
    async onSubmit() {
      ...
      if (this.operation === "add") {
        ...
        await this.$https({
          ...
          params: {
            table: "__SHTreatmentMethod",
            where: { TreatmentMethod: this.form.TreatmentMethod },
            dataBase: "base",
          },
        })
          .then((res) => {

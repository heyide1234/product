  ...
  <div class="container">
    ...
    <div class="tabels">
      ...
      >
        ...
        <el-table-column label="生成领料确认" min-width="150" fixed="right">
          <template slot-scope="scope">
  ...
  methods: {
    ...
    lld(id) {
      this.$https({
        ...
        data: {
          table: "processList",
          id: id,
          form: { status: "2", creater1: sessionStorage.getItem("loginName") },
        },
      })
        .then(function (res) {
          console.log(res);
    ...
    find() {
      this.$https({
        ...
        params: {
          table: "processList",
          where: { status: "1", SerialNumber: this.form.SerialNumber },
        },
      })
        .then((res) => {
          this.tableData = res;

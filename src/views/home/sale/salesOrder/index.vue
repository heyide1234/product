...
export default {
  ...
  methods: {
    ...
    //////////////////////
    // async tdprocess(datas, OrderNumber) {
    //   //库存盈余表检查
    //   await this.yyFind(datas); //
    //   //检测是否全部完成，进入推单模式
    //   let stt = "8";
    //   datas.forEach((item) => {
    //     if (item.Number != "0") {
    ...
    //   });
    //   //订单编号
    //   await this.getProcessState(OrderNumber, "salesOrderDetail", "-1", stt);
    //   // //循环添加销售发货单和当前销售单明细状态
    ...
    //     await this.updateXSMX(data[i]._id, data[i].Number);
    //   }
    // },

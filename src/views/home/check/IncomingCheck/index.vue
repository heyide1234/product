...
export default {
  ...
  methods: {
    ...
    //////////////////////////////////////////////////////////////////
    async handleEdit1(form, row, TotalCheckNum, Checker, time) {
      ...
      await this.update(fs, row._id); //修改检验数据
      ////////////////////////////////////////////////////////////
      //增加材料入库单
      ...
      //进入推单模式
      this.getProcessState(row.OrderNumber, "7");
    },
    //编辑事件
    async handleEdit(scope) {
      ...
      this.$https({
        method: "post",
        url: "api/transaction/IncomingCheckTransaction",
        data: {
          form: this.form,
          row: scope.row,
          TotalCheckNum: TotalCheckNum,

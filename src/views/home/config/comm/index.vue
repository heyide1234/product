  ...
  <div class="container">
    ...
    >
      <el-form ref="form" :model="form">
        ...
        <el-form-item label="值">
          <el-input v-model="form.values" type="text"></el-input>
        </el-form-item>
    ...
    <div class="tabels">
      ...
      >
        ...
        <el-table-column property="KeyName" label="键名"></el-table-column>
        <el-table-column property="values" label="值"></el-table-column>
    ...
    async onSubmit() {
      if (this.operation === "add") {
        ...
        await this.$https({
          ...
          params: {
            table: "__comm",
            where: { KeyName: this.form.KeyName },
            dataBase: "base",
          },
        })
          .then((res) => {
